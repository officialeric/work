            ...
            <div>
                ...
                <div class="mt-3">
                    ...
                    <div class="grid grid-cols-4 gap-2">
                        <button type="button" onclick="selectIcon('fas fa-solar-panel')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-solar-panel text-gray-600"></i>
                            <span class="block text-xs mt-1">Solar</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-tint')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-tint text-gray-600"></i>
                            <span class="block text-xs mt-1">Water</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-leaf')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-leaf text-gray-600"></i>
                            <span class="block text-xs mt-1">Eco</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-recycle')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-recycle text-gray-600"></i>
                            <span class="block text-xs mt-1">Recycle</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-hammer')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-hammer text-gray-600"></i>
                            <span class="block text-xs mt-1">Build</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-car-battery')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-car-battery text-gray-600"></i>
                            <span class="block text-xs mt-1">Electric</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-filter')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
                            <i class="fas fa-filter text-gray-600"></i>
                            <span class="block text-xs mt-1">Filter</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-tree')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-golden-50 hover:border-golden-300 transition-colors duration-200">
