...
@section('page-title', 'Create New Commitment')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Commitment Information</h2>
            <p class="text-sm text-gray-600 mt-1">Fill in the details for the new eco-tourism commitment</p>
        </div>

        <form action="{{ route('admin.commitments.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="mt-3">
                    ...
                    <div class="grid grid-cols-4 gap-2">
                        <button type="button" onclick="selectIcon('fas fa-solar-panel')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-solar-panel text-gray-600"></i>
                            <span class="block text-xs mt-1">Solar</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-tint')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-tint text-gray-600"></i>
                            <span class="block text-xs mt-1">Water</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-leaf')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-leaf text-gray-600"></i>
                            <span class="block text-xs mt-1">Eco</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-recycle')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-recycle text-gray-600"></i>
                            <span class="block text-xs mt-1">Recycle</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-hammer')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-hammer text-gray-600"></i>
                            <span class="block text-xs mt-1">Build</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-car-battery')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-car-battery text-gray-600"></i>
                            <span class="block text-xs mt-1">Electric</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-filter')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
                            <i class="fas fa-filter text-gray-600"></i>
                            <span class="block text-xs mt-1">Filter</span>
                        </button>
                        <button type="button" onclick="selectIcon('fas fa-tree')" class="icon-btn p-2 border border-gray-300 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 transition-colors duration-200">
